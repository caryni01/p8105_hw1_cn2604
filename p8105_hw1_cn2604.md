...
The **penguins** dataset has 344 rows and 8 columns. The flipper length
is 200.92mm. <!-- The appearance of __penguins__ dataset is 
...
as.numeric function does not work for *var_char*, but work for
*var_logical* and *var_factor*.
